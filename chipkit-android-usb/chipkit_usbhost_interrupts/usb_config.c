...
USB_TPL usbTPL[NUM_TPL_ENTRIES] =
{
    ...
    { INIT_VID_PID( 0x18D1ul, 0x2D02ul ), 0, 1, {0} }, // Android accessory
    { INIT_VID_PID( 0x18D1ul, 0x2D03ul ), 0, 1, {0} }, // Android accessory
    { INIT_VID_PID( 0x18D1ul, 0x2D04ul ), 0, 1, {0} }, // Android accessory
    { INIT_VID_PID( 0x18D1ul, 0x2D05ul ), 0, 1, {0} }, // Android accessory
    { INIT_VID_PID( 0x2916ul, 0x9039ul ), 0, 1, {0} }, // Yotaphone
